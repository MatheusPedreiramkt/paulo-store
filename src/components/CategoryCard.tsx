    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
          <h3 className="text-white text-base font-bold tracking-wide uppercase mb-2">
            {label}
          </h3>
          <span className="inline-flex items-center gap-1.5 text-white/60 text-xs tracking-wider uppercase group-hover:text-white group-hover:gap-3 transition-all duration-300">
            Comprar
            <ArrowRight size={11} />
          </span>
        </div>
